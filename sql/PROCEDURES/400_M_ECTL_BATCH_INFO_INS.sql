...
CREATE OR REPLACE PROCEDURE ALFA_EDW_DEV.PUBLIC.M_ECTL_BATCH_INFO_INS("RUN_ID" VARCHAR)
RETURNS VARCHAR
LANGUAGE SQL
EXECUTE AS CALLER
AS ' 
...
(
SELECT
:ECTL_ACTIVE_IND as out_ECTL_BATCH_IND,
...
(
SELECT
CASE WHEN LKP_ECTL_BATCH_INFO.ECTL_BATCH_ID IS NOT NULL THEN 1/0 
--RAISE_ERROR(''Batch already exists'') 
