...
CREATE OR REPLACE PROCEDURE ALFA_EDW_DEV.PUBLIC.M_PS_ALF_REPOS_S3C("RUN_ID" VARCHAR)
RETURNS VARCHAR
LANGUAGE SQL
EXECUTE AS CALLER
AS ' BEGIN 
...
$56 as ALF_BATCH_TYPE,
$57 as ALF_BATCH_DATE,
$58 as ALF_BATCH_SEQ_NBR,
$59 as ALF_TRANS_SEQ_NBR,
$60 as ALF_GW_POLICY_TYPE,
$61 as ALF_GW_LINE_OF_BUS,
$62 as ALF_TRANS_CAT,
$63 as ALF_CL_INT_EVNT_ID,
$64 as ALF_CHK_NBR,
$65 as ALF_COMBIN_CHK_NBR,
$66 as source_record_id
FROM (
SELECT SRC.*, row_number() over (order by 1) AS source_record_id FROM (
SELECT BUSINESS_UNIT, TRANSACTION_ID, DTTM_STAMP, ALF_REC_COUNTER, LEDGER_GROUP, LEDGER, JOURNAL_ID, JOURNAL_LINE, FISCAL_YEAR, ACCOUNTING_PERIOD, JOURNAL_DATE, ACCOUNT, DEPTID, PRODUCT, PROJECT_ID, CHARTFIELD1, CHARTFIELD2, CHARTFIELD3, AFFILIATE, ALF_POL_SYMBOL, ALF_POLICY_NBR, ALF_COV_TYPE, ALF_AGT_NBR, ALF_SERV_CTR_NBR, ALF_COMPANY_CD, ALF_TRANS_OBJ_CD, ALF_TRANS_ACT_CD, ALF_LOB_CD, ALF_POLICY_ID, ALF_CLAIM_NBR, ALF_CLAIMENT_ID, ALF_CLAIM_OBJ_TYPE, ALF_CLAIM_OBJ_SEQ, ALF_ADJUSTER_NBR, ALF_DATE_OF_LOSS, ALF_LAWSUIT_CD, ALF_MICRO_ECD_NBR, ALF_POOL_CD, ALF_CAT_POOL_LVL, ALF_CAT_POOL_YYYY, ALF_ACCT_DT, MONETARY_AMOUNT, CURRENCY_CD, STATISTIC_AMOUNT, STATISTICS_CODE, FOREIGN_AMOUNT, FOREIGN_CURRENCY, APPL_JRNL_ID, BUSINESS_UNIT_GL, ACCOUNTING_DT, GL_DISTRIB_STATUS, JRNL_LN_REF, JRNL_DESCR, PROCESS_INSTANCE, ALF_OFFSET_IND, ALF_BATCH_TYPE, ALF_BATCH_DATE, ALF_BATCH_SEQ_NBR, ALF_TRANS_SEQ_NBR, ALF_GW_POLICY_TYPE, ALF_GW_LINE_OF_BUS, ALF_TRANS_CAT, ALF_CL_INT_EVNT_ID, ALF_CHK_NBR, ALF_COMBIN_CHK_NBR 

FROM DB_T_STAG_FIN_PROD.PS_ALF_REPOS_S3C_S WHERE FISCAL_YEAR = :PSYR_ID AND ACCOUNTING_PERIOD = :PSMO_ID UNION ALL

SELECT BUSINESS_UNIT, TRANSACTION_ID, DTTM_STAMP, ALF_REC_COUNTER, LEDGER_GROUP, LEDGER, JOURNAL_ID, JOURNAL_LINE, FISCAL_YEAR, ACCOUNTING_PERIOD, JOURNAL_DATE, ACCOUNT, DEPTID, PRODUCT, PROJECT_ID, CHARTFIELD1, CHARTFIELD2, CHARTFIELD3, AFFILIATE, ALF_POL_SYMBOL, ALF_POLICY_NBR, ALF_COV_TYPE, ALF_AGT_NBR, ALF_SERV_CTR_NBR, ALF_COMPANY_CD, ALF_TRANS_OBJ_CD, ALF_TRANS_ACT_CD, ALF_LOB_CD, ALF_POLICY_ID, ALF_CLAIM_NBR, ALF_CLAIMENT_ID, ALF_CLAIM_OBJ_TYPE, ALF_CLAIM_OBJ_SEQ, ALF_ADJUSTER_NBR, ALF_DATE_OF_LOSS, ALF_LAWSUIT_CD, ALF_MICRO_ECD_NBR, ALF_POOL_CD, ALF_CAT_POOL_LVL, ALF_CAT_POOL_YYYY, ALF_ACCT_DT, MONETARY_AMOUNT, CURRENCY_CD, STATISTIC_AMOUNT, STATISTICS_CODE, FOREIGN_AMOUNT, FOREIGN_CURRENCY, APPL_JRNL_ID, BUSINESS_UNIT_GL, ACCOUNTING_DT, GL_DISTRIB_STATUS, JRNL_LN_REF, JRNL_DESCR, PROCESS_INSTANCE, ALF_OFFSET_IND, ALF_BATCH_TYPE, ALF_BATCH_DATE, ALF_BATCH_SEQ_NBR, ALF_TRANS_SEQ_NBR, ALF_GW_POLICY_TYPE, ALF_GW_LINE_OF_BUS, ALF_TRANS_CAT, ALF_CL_INT_EVNT_ID, ALF_CHK_NBR, ALF_COMBIN_CHK_NBR 

FROM PS_DB2_OWNER.PS_ALF_REPOS_S3C_A WHERE FISCAL_YEAR = PSYR_ID AND ACCOUNTING_PERIOD = PSMO_ID
) SRC
)
);
...
SQ_PS_ALF_REPOS_S3C_S.ACCOUNT as ACCOUNT,
...
SQ_PS_ALF_REPOS_S3C_S.ALF_GW_POLICY_TYPE as ALF_GW_POLICY_TYPE,
SQ_PS_ALF_REPOS_S3C_S.source_record_id
FROM
SQ_PS_ALF_REPOS_S3C_S
);


-- Component PS_ALF_REPOS_S3C_S2, Type TARGET 
INSERT INTO DB_T_STAG_FIN_PROD.PS_ALF_REPOS_S3C_S
(
BUSINESS_UNIT,
TRANSACTION_ID,
DTTM_STAMP,
...
exp_pass_through.ALF_POL_SYMBOL as ALF_POL_SYMBOL,
...
exp_pass_through.ALF_CLAIM_NBR as ALF_CLAIM_NBR,
exp_pass_through.ALF_CLAIMENT_ID as ALF_CLAIMENT_ID,
exp_pass_through.ALF_CLAIM_OBJ_TYPE as ALF_CLAIM_OBJ_TYPE,
exp_pass_through.ALF_CLAIM_OBJ_SEQ as ALF_CLAIM_OBJ_SEQ,
exp_pass_through.ALF_ADJUSTER_NBR as ALF_ADJUSTER_NBR,
exp_pass_through.ALF_DATE_OF_LOSS as ALF_DATE_OF_LOSS,
exp_pass_through.ALF_LAWSUIT_CD as ALF_LAWSUIT_CD,
exp_pass_through.ALF_MICRO_ECD_NBR as ALF_MICRO_ECD_NBR,
exp_pass_through.ALF_POOL_CD as ALF_POOL_CD,
...
exp_pass_through.ALF_OFFSET_IND as ALF_OFFSET_IND,
exp_pass_through.ALF_GW_POLICY_TYPE as ALF_GW_POLICY_TYPE
FROM
exp_pass_through;
...
-- Component SQ_PS_ALF_REPOS_S3C_S1, Type SOURCE 
CREATE OR REPLACE TEMPORARY TABLE SQ_PS_ALF_REPOS_S3C_S1 AS
(
SELECT /* adding column aliases to ensure proper downstream column references */
$1 as CNT,
...
FROM (
SELECT SRC.*, row_number() over (order by 1) AS source_record_id FROM (
with c AS (select count(1) CNT FROM PS_ALF_REPOS_S3C_S) 

 ,s AS (SELECT  COALESCE(SUM(CAST(MONETARY_AMOUNT AS FLOAT)), 0) AS MONETARY_AMOUNT

FROM DB_T_STAG_FIN_PROD.PS_ALF_REPOS_S3C_S
...
-- Component exp_ps_alf_repos_s3c, Type EXPRESSION 
CREATE OR REPLACE TEMPORARY TABLE exp_ps_alf_repos_s3c AS
(
SELECT
SQ_PS_ALF_REPOS_S3C_S1.CNT as record_count,
...
to_char ( SQ_PS_ALF_REPOS_S3C_S1.MONETARY_AMOUNT ) as o_MONETARY_AMOUNT,
FIELD1,
FIELD2,
FIELD3,
FIELD4,
...
FIELD25,
FIELD26,
SQ_PS_ALF_REPOS_S3C_S1.source_record_id
FROM
SQ_PS_ALF_REPOS_S3C_S1
);
...
(
SELECT
exp_ps_alf_repos_s3c.feed_ind as feed_ind,
exp_ps_alf_repos_s3c.feed_dt as feed_dt,
exp_ps_alf_repos_s3c.record_count as record_cnt,
exp_ps_alf_repos_s3c.o_MONETARY_AMOUNT as monetary_amount,
exp_ps_alf_repos_s3c.FIELD1 as FIELD1,
exp_ps_alf_repos_s3c.FIELD2 as FIELD2,
exp_ps_alf_repos_s3c.FIELD3 as FIELD3,
exp_ps_alf_repos_s3c.FIELD4 as FIELD4,
exp_ps_alf_repos_s3c.FIELD5 as FIELD5,
exp_ps_alf_repos_s3c.FIELD6 as FIELD6,
exp_ps_alf_repos_s3c.FIELD7 as FIELD7,
exp_ps_alf_repos_s3c.FIELD8 as FIELD8,
exp_ps_alf_repos_s3c.FIELD9 as FIELD9,
exp_ps_alf_repos_s3c.FIELD10 as FIELD10,
exp_ps_alf_repos_s3c.FIELD11 as FIELD11,
exp_ps_alf_repos_s3c.FIELD12 as FIELD12,
exp_ps_alf_repos_s3c.FIELD13 as FIELD13,
exp_ps_alf_repos_s3c.FIELD14 as FIELD14,
exp_ps_alf_repos_s3c.FIELD15 as FIELD15,
exp_ps_alf_repos_s3c.FIELD16 as FIELD16,
exp_ps_alf_repos_s3c.FIELD17 as FIELD17,
exp_ps_alf_repos_s3c.FIELD18 as FIELD18,
exp_ps_alf_repos_s3c.FIELD19 as FIELD19,
exp_ps_alf_repos_s3c.FIELD20 as FIELD20,
exp_ps_alf_repos_s3c.FIELD21 as FIELD21,
exp_ps_alf_repos_s3c.FIELD22 as FIELD22,
exp_ps_alf_repos_s3c.FIELD23 as FIELD23,
exp_ps_alf_repos_s3c.FIELD24 as FIELD24,
exp_ps_alf_repos_s3c.FIELD25 as FIELD25,
exp_ps_alf_repos_s3c.FIELD26 as FIELD26
FROM
exp_ps_alf_repos_s3c
);
