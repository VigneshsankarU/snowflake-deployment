...
CREATE OR REPLACE PROCEDURE ALFA_EDW_DEV.PUBLIC.M_CLMF_CLM_LOSS_RESERVE_CORE_WC("RUN_ID" VARCHAR)
RETURNS VARCHAR
LANGUAGE SQL
EXECUTE AS CALLER
...
-- Component sq_STG_CLMF_CLM_LOSS_RESERVE_WC, Type SOURCE 
CREATE OR REPLACE TEMPORARY TABLE sq_STG_CLMF_CLM_LOSS_RESERVE_WC AS
(
...
SELECT	
	...
	,LR_S.DETN_L
FROM	DB_T_STAG_PROD.STG_CLMF_CLM_LOSS_RESERVE_WC  LR_S 
...
(
SELECT
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.ROW_NUMBER as ROW_NUMBER,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.CLAIM_SKEY as CLAIM_SKEY,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.MRI as MRI,
...
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.LR_LINE_L as LR_LINE_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.LR_END_L as LR_END_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.LR_COV_L as LR_COV_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.LR_INO_NOC_L as LR_INO_NOC_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.LR_TX_L as LR_TX_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.LR_ACCTNO_L as LR_ACCTNO_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.LR_REL_L as LR_REL_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.LR_DPX_L as LR_DPX_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.LR_DNO_L as LR_DNO_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.LR_DAMT_L as LR_DAMT_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.LR_IODT_L as LR_IODT_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.LR_IODT_L_DATE as LR_IODT_L_DATE,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.LR_PCDT_L as LR_PCDT_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.LR_PCDT_L_DATE as LR_PCDT_L_DATE,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.LR_VOID_L as LR_VOID_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.LR_CLASS_L as LR_CLASS_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.LR_TEN_L as LR_TEN_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.LR_INS_L as LR_INS_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.LR_TIN_L as LR_TIN_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.COML_EXPOBASE_L as COML_EXPOBASE_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.COML_EXPO_L as COML_EXPO_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.LR_COTPLN_L as LR_COTPLN_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.LR_LIMIT_L as LR_LIMIT_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.LR_DEDUCT_L as LR_DEDUCT_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.LR_CNSTR_YR_L as LR_CNSTR_YR_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.LR_CF_POL_NBR_L as LR_CF_POL_NBR_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.LR_GB_PAYEE_L as LR_GB_PAYEE_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.LR_GB_INVOICE_PFX_L as LR_GB_INVOICE_PFX_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.LR_GB_INVOICE_NBR_L as LR_GB_INVOICE_NBR_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.CAT_POOL_CCYY_L as CAT_POOL_CCYY_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.CAT_POOL_LEVEL_L as CAT_POOL_LEVEL_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.CAT_POOL_ACT_DATE_L as CAT_POOL_ACT_DATE_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.CAT_POOL_ACT_DATE as CAT_POOL_ACT_DATE,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.CAT_POOL_RUN_TYPE_L as CAT_POOL_RUN_TYPE_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.LOSS_RES_ADJ_L as LOSS_RES_ADJ_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.ACT_CD_L as ACT_CD_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.DRAFT_CD_L as DRAFT_CD_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.DETN_L as DETN_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_WC.source_record_id,
row_number() over (partition by sq_STG_CLMF_CLM_LOSS_RESERVE_WC.source_record_id order by sq_STG_CLMF_CLM_LOSS_RESERVE_WC.source_record_id) as RNK
FROM
sq_STG_CLMF_CLM_LOSS_RESERVE_WC
...
LEFT OUTER JOIN (
	...
	FROM DB_T_STAG_PROD.STG_CLMF_CLM_LOSS_RESERVE_WC
...
''UPD'' as out_CHECK3,
 rtr_INS_UPD_UPD.out_CHG_EFF_DT  - 1  as out_CHG_EXP_DT,
...
USING upd_TARGET
ON (LOSS_RESERVE_SKEY = upd_TARGET.LOSS_RESERVE_SKEY3 and CLAIM_SKEY = upd_TARGET.CLAIM_SKEY_lkp3 and CHG_EFF_DT = upd_TARGET.CHG_EFF_DT_lkp3 )
