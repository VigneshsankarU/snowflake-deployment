...
CREATE OR REPLACE PROCEDURE ALFA_EDW_DEV.PUBLIC.M_SHRD_ECTL_JOB_LOAD_STATUS_LOG_INS("RUN_ID" VARCHAR)
RETURNS VARCHAR
LANGUAGE SQL
EXECUTE AS CALLER
...
DB_T_CTRL_FIN_PROD.ECTL_BATCH_INFO B WHERE ECTL_PROJ_ID = CAST(TRIM(''$ACT_PROJ_ID'') AS INTEGER) AND ECTL_ACTIVE_IND = ''Y''
) SRC
)
);
...
SQ_Shortcut_to_ECTL_BATCH_INFO.DATABASE_NM as DATABASE_NM,
SQ_Shortcut_to_ECTL_BATCH_INFO.ECTL_PROJ_ID as ECTL_PROJ_ID,
SQ_Shortcut_to_ECTL_BATCH_INFO.DAILY_FEED_IND as DAILY_FEED_IND,
SQ_Shortcut_to_ECTL_BATCH_INFO.DT_ID as DT_ID,
SQ_Shortcut_to_ECTL_BATCH_INFO.MO_ID as MO_ID,
SQ_Shortcut_to_ECTL_BATCH_INFO.BI_FOLDER_NM as BI_FOLDER_NM,
SQ_Shortcut_to_ECTL_BATCH_INFO.JOB_NM as JOB_NM,
SQ_Shortcut_to_ECTL_BATCH_INFO.TASK_NM as TASK_NM,
SQ_Shortcut_to_ECTL_BATCH_INFO.TASK_TYPE as TASK_TYPE,
SQ_Shortcut_to_ECTL_BATCH_INFO.WF_START_TS as WF_START_TS,
...
-- Component ECTL_JOB_LOAD_STATUS_LOG, Type TARGET 
