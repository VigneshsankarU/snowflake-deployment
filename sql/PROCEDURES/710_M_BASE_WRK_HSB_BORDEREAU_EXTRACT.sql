...
CREATE OR REPLACE PROCEDURE ALFA_EDW_DEV.PUBLIC.M_BASE_WRK_HSB_BORDEREAU_EXTRACT("WORKLET_NAME" VARCHAR)
RETURNS VARCHAR
LANGUAGE SQL
EXECUTE AS CALLER
AS ' 
...
SELECT HSB_BORDEREAU.TRANS_ID, HSB_BORDEREAU.PROD_CD, HSB_BORDEREAU.PROD_ID, HSB_BORDEREAU.POL_NBR, HSB_BORDEREAU.TRANS_TYPE, HSB_BORDEREAU.TRANS_EFF_DT, HSB_BORDEREAU.POL_EFF_DT, HSB_BORDEREAU.POL_TERM_EXP_DT, HSB_BORDEREAU.TRANS_PREM_GROSS, HSB_BORDEREAU.TRANS_PREM_NET, HSB_BORDEREAU.PREV_POL_NBR, HSB_BORDEREAU.PROG_ID, HSB_BORDEREAU.NAMED_INSRD, HSB_BORDEREAU.CNTRCT_NUM, HSB_BORDEREAU.UW_CMPNY, HSB_BORDEREAU.POL_RSK_ST, HSB_BORDEREAU.POL_TYPE_DESC, HSB_BORDEREAU.MAIL_CITY, HSB_BORDEREAU.MAIL_ST, HSB_BORDEREAU.MAIL_ZIP, HSB_BORDEREAU.HSB_BRANCH_CD, HSB_BORDEREAU.TOT_PROP_PREM, HSB_BORDEREAU.TRANS_ENTRY_DT, HSB_BORDEREAU.COVERAGE_CD, HSB_BORDEREAU.COMMISSION_RATE, HSB_BORDEREAU.EB_TREATY_RATE 
...
(
SELECT
EXPTRANS2.C1_Record_Type as Record_Type,
EXPTRANS2.C1_Company_Product_ID as Company_Product_ID,
