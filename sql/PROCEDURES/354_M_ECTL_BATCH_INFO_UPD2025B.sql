...
CREATE OR REPLACE PROCEDURE ALFA_EDW_DEV.PUBLIC.M_ECTL_BATCH_INFO_UPD2025B("RUN_ID" VARCHAR)
RETURNS VARCHAR
LANGUAGE SQL
EXECUTE AS CALLER
AS ' DECLARE PROJ_ID varchar;
BEGIN 
...
AND ECTL_BATCH_INFO.ECTL_PROJ_ID=:PROJ_ID
) SRC
)
);
...
/* Perform Updates */
MERGE INTO DB_T_CTRL_PROD.ECTL_BATCH_INFO
USING upd_ECTL_BATCH_INFO
ON (DB_T_CTRL_PROD.ECTL_BATCH_INFO.ECTL_BATCH_ID = upd_ECTL_BATCH_INFO.ECTL_BATCH_ID AND DB_T_CTRL_PROD.ECTL_BATCH_INFO.ECTL_PROJ_ID = upd_ECTL_BATCH_INFO.ECTL_PROJ_ID)
