...
CREATE OR REPLACE PROCEDURE ALFA_EDW_DEV.PUBLIC.M_CLMF_CLM_LOSS_RESERVE_CORE_HO("RUN_ID" VARCHAR)
RETURNS VARCHAR
LANGUAGE SQL
EXECUTE AS CALLER
AS ' 
...
-- Component sq_STG_CLMF_CLM_LOSS_RESERVE_HO, Type SOURCE 
CREATE OR REPLACE TEMPORARY TABLE sq_STG_CLMF_CLM_LOSS_RESERVE_HO AS
(
...
SELECT	
	...
	,LR_S.DETN_L
FROM	DB_T_STAG_PROD.STG_CLMF_CLM_LOSS_RESERVE_HO  LR_S 
...
(
(CMPY_CD in (10) and PLCY_PREFIX in (12,13,14,15,17,18,19,20,21,22,23,26,60,61))
or
(CMPY_CD in (11) and PLCY_PREFIX =19)
or
(CMPY_CD in (40) and PLCY_PREFIX in (13,14,15,18,19,20,21,60,61))
or
(CMPY_CD in (50) and PLCY_PREFIX in (15))
or
(CMPY_CD in (60) and PLCY_PREFIX in (60,61))
or
(CMPY_CD in (70) and PLCY_PREFIX =15)) 
...
(
SELECT
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.ROW_NUMBER as ROW_NUMBER,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.CLAIM_SKEY as CLAIM_SKEY,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.MRI as MRI,
...
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.LR_LINE_L as LR_LINE_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.LR_END_L as LR_END_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.LR_COV_L as LR_COV_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.LR_INO_NOC_L as LR_INO_NOC_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.LR_TX_L as LR_TX_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.LR_ACCTNO_L as LR_ACCTNO_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.LR_REL_L as LR_REL_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.LR_DPX_L as LR_DPX_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.LR_DNO_L as LR_DNO_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.LR_DAMT_L as LR_DAMT_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.LR_IODT_L as LR_IODT_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.LR_IODT_L_DATE as LR_IODT_L_DATE,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.LR_PCDT_L as LR_PCDT_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.LR_PCDT_L_DATE as LR_PCDT_L_DATE,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.LR_VOID_L as LR_VOID_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.LR_CLASS_L as LR_CLASS_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.LR_TEN_L as LR_TEN_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.LR_INS_L as LR_INS_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.LR_TIN_L as LR_TIN_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.COML_EXPOBASE_L as COML_EXPOBASE_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.COML_EXPO_L as COML_EXPO_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.LR_COTPLN_L as LR_COTPLN_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.LR_LIMIT_L as LR_LIMIT_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.LR_DEDUCT_L as LR_DEDUCT_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.LR_CNSTR_YR_L as LR_CNSTR_YR_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.LR_CF_POL_NBR_L as LR_CF_POL_NBR_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.LR_GB_PAYEE_L as LR_GB_PAYEE_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.LR_GB_INVOICE_PFX_L as LR_GB_INVOICE_PFX_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.LR_GB_INVOICE_NBR_L as LR_GB_INVOICE_NBR_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.CAT_POOL_CCYY_L as CAT_POOL_CCYY_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.CAT_POOL_LEVEL_L as CAT_POOL_LEVEL_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.CAT_POOL_ACT_DATE_L as CAT_POOL_ACT_DATE_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.CAT_POOL_ACT_DATE as CAT_POOL_ACT_DATE,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.CAT_POOL_RUN_TYPE_L as CAT_POOL_RUN_TYPE_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.LOSS_RES_ADJ_L as LOSS_RES_ADJ_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.ACT_CD_L as ACT_CD_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.DRAFT_CD_L as DRAFT_CD_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.DETN_L as DETN_L,
sq_STG_CLMF_CLM_LOSS_RESERVE_HO.source_record_id,
row_number() over (partition by sq_STG_CLMF_CLM_LOSS_RESERVE_HO.source_record_id order by sq_STG_CLMF_CLM_LOSS_RESERVE_HO.source_record_id) as RNK
FROM
sq_STG_CLMF_CLM_LOSS_RESERVE_HO
...
LEFT OUTER JOIN (
	SELECT ROW_NUMBER() OVER (
		...
		,DRAFT_CD_L
		,DETN_L
	FROM db_t_stag_prod.STG_CLMF_CLM_LOSS_RESERVE_HO
...
SELECT
exp_UPD.CLAIM_SKEY_lkp3 as CLAIM_SKEY,
exp_UPD.out_CHECK3 as CHECK3,
exp_UPD.out_ECTL_BATCH_ID3 as ECTL_BATCH_ID,
exp_UPD.out_ORIG_INS_TS3 as ORIG_INS_TS,
exp_UPD.out_CHG_EXP_DT as CHG_EXP_DT,
exp_UPD.out_ECTL_END_DATE as ECTL_END_DATE,
exp_UPD.CHG_EFF_DT_lkp3 as CHG_EFF_DT,
exp_UPD.LOSS_RESERVE_SKEY3 as LOSS_RESERVE_SKEY,
exp_UPD.out_ECTL_BATCH_START_DATE3 as ECTL_BATCH_START_DATE,
...
/* Perform Updates */
MERGE INTO db_t_core_prod.CLMF_CLM_LOSS_RESERVE_CORE 
USING upd_TARGET
ON (db_t_core_prod.CLMF_CLM_LOSS_RESERVE_CORE.LOSS_RESERVE_SKEY = upd_TARGET.LOSS_RESERVE_SKEY and db_t_core_prod.CLMF_CLM_LOSS_RESERVE_CORE.CLAIM_SKEY = upd_TARGET.CLAIM_SKEY and db_t_core_prod.CLMF_CLM_LOSS_RESERVE_CORE.CHG_EFF_DT = upd_TARGET.CHG_EFF_DT and db_t_core_prod.CLMF_CLM_LOSS_RESERVE_CORE.CLAIM_SKEY = upd_TARGET.CLAIM_SKEY)
WHEN MATCHED THEN UPDATE SET
CHG_EXP_DT = upd_TARGET.CHG_EXP_DT, ECTL_BATCH_ID = upd_TARGET.ECTL_BATCH_ID, ECTL_MODIFY_TS = upd_TARGET.ORIG_INS_TS, 
--ECTL_TX_CD = upd_TARGET.ECTL_TX_CD, 
ECTL_START_DATE = upd_TARGET.ECTL_BATCH_START_DATE, ECTL_END_DATE = upd_TARGET.ECTL_END_DATE;
