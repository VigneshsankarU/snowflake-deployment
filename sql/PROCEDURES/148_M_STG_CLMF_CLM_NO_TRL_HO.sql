...
CREATE OR REPLACE PROCEDURE ALFA_EDW_DEV.PUBLIC.M_STG_CLMF_CLM_NO_TRL_HO("RUN_ID" VARCHAR)
RETURNS VARCHAR
LANGUAGE SQL
EXECUTE AS CALLER
AS ' BEGIN 

-- Component amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL, Type SOURCE 
CREATE OR REPLACE TEMPORARY TABLE amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL AS
(
...
SELECT
clmfdm_CLMF_CLM_HO_NO_TRL.OPERATOR_ID,
clmfdm_CLMF_CLM_HO_NO_TRL.COMPANY,
clmfdm_CLMF_CLM_HO_NO_TRL.MRI,
clmfdm_CLMF_CLM_HO_NO_TRL.TRL_COUNT,
clmfdm_CLMF_CLM_HO_NO_TRL.POL_STATE,
clmfdm_CLMF_CLM_HO_NO_TRL.PFX,
clmfdm_CLMF_CLM_HO_NO_TRL.PNO,
clmfdm_CLMF_CLM_HO_NO_TRL.DATE_O_LOSS,
clmfdm_CLMF_CLM_HO_NO_TRL.SEQNO,
clmfdm_CLMF_CLM_HO_NO_TRL.TRANS_ID,
clmfdm_CLMF_CLM_HO_NO_TRL.DIST,
clmfdm_CLMF_CLM_HO_NO_TRL.ADJSYM,
clmfdm_CLMF_CLM_HO_NO_TRL.FAST_TRAC,
clmfdm_CLMF_CLM_HO_NO_TRL.GLASBRK,
clmfdm_CLMF_CLM_HO_NO_TRL.SUSP,
clmfdm_CLMF_CLM_HO_NO_TRL.SAL_SUB,
clmfdm_CLMF_CLM_HO_NO_TRL.SUIT_CD,
clmfdm_CLMF_CLM_HO_NO_TRL.SLC_CD,
clmfdm_CLMF_CLM_HO_NO_TRL.REPT_DT,
clmfdm_CLMF_CLM_HO_NO_TRL.ACCTG_DT,
clmfdm_CLMF_CLM_HO_NO_TRL.CAUSE_CD,
clmfdm_CLMF_CLM_HO_NO_TRL.CAUSE_DESC,
clmfdm_CLMF_CLM_HO_NO_TRL.COT_PLN,
clmfdm_CLMF_CLM_HO_NO_TRL.CAT_CD,
clmfdm_CLMF_CLM_HO_NO_TRL.RISK_ID,
clmfdm_CLMF_CLM_HO_NO_TRL.CLOSE_CD,
clmfdm_CLMF_CLM_HO_NO_TRL.CLOSE_DT,
clmfdm_CLMF_CLM_HO_NO_TRL.NO_REO,
clmfdm_CLMF_CLM_HO_NO_TRL.REIN,
clmfdm_CLMF_CLM_HO_NO_TRL.ENC_CD,
clmfdm_CLMF_CLM_HO_NO_TRL.AGTNO,
clmfdm_CLMF_CLM_HO_NO_TRL.SCNO,
clmfdm_CLMF_CLM_HO_NO_TRL.INSD_NM,
clmfdm_CLMF_CLM_HO_NO_TRL.OCC_CD,
clmfdm_CLMF_CLM_HO_NO_TRL.TIME_O_LOSS,
clmfdm_CLMF_CLM_HO_NO_TRL.SUBROGATION_DATE,
clmfdm_CLMF_CLM_HO_NO_TRL.PURG_CLM_FROM_FOLDER,
clmfdm_CLMF_CLM_HO_NO_TRL.RECOVERABLE_LOSS_CD,
clmfdm_CLMF_CLM_HO_NO_TRL.RECOVERABLE_LOSS_AMT,
clmfdm_CLMF_CLM_HO_NO_TRL.PREM_FINANCE,
clmfdm_CLMF_CLM_HO_NO_TRL.HIGH_PERFORM_CODE,
clmfdm_CLMF_CLM_HO_NO_TRL.FIBER_GLASS_CODE,
clmfdm_CLMF_CLM_HO_NO_TRL.INEXPER_DRVR_CODE,
clmfdm_CLMF_CLM_HO_NO_TRL.FINANCIAL_RESPONBILITY_CODE,
clmfdm_CLMF_CLM_HO_NO_TRL.MISC_DISCOUNT,
clmfdm_CLMF_CLM_HO_NO_TRL.HO_DISCOUNT,
clmfdm_CLMF_CLM_HO_NO_TRL.SM_SP_POLICY_IND,
clmfdm_CLMF_CLM_HO_NO_TRL.PREV_AGENT,
clmfdm_CLMF_CLM_HO_NO_TRL.CHANGE_AGT_DT,
clmfdm_CLMF_CLM_HO_NO_TRL.WC_EFF_YR,
clmfdm_CLMF_CLM_HO_NO_TRL.POL_FOLDER_DATE,
clmfdm_CLMF_CLM_HO_NO_TRL.TRANSFERRED_POL_NBR,
clmfdm_CLMF_CLM_HO_NO_TRL.CLUE_CHANGE_MMYY,
clmfdm_CLMF_CLM_HO_NO_TRL.CLUE_REPT_ITEM,
clmfdm_CLMF_CLM_HO_NO_TRL.MISS_FIRE_CLM_IND,
clmfdm_CLMF_CLM_HO_NO_TRL.TIMES_NOT_FOUND,
clmfdm_CLMF_CLM_HO_NO_TRL.TOT_RES_AMT,
clmfdm_CLMF_CLM_HO_NO_TRL.TOT_PAID_AMT,
clmfdm_CLMF_CLM_HO_NO_TRL.HO_DEDUCTIBLE
FROM clmfdm_CLMF_CLM_HO_NO_TRL
) SRC
)
);
...
(
SELECT
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.OPERATOR_ID as OPERATOR_ID,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.COMPANY as COMPANY,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.MRI as MRI,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.TRL_COUNT as TRL_COUNT,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.POL_STATE as POL_STATE,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.PFX as PFX,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.PNO as PNO,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.DATE_O_LOSS as DATE_O_LOSS,
DATECONV_CYYMMDD ( amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.DATE_O_LOSS ) as out_DATE_O_LOSS,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.SEQNO as SEQNO,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.TRANS_ID as TRANS_ID,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.DIST as DIST,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.ADJSYM as ADJSYM,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.FAST_TRAC as FAST_TRAC,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.GLASBRK as GLASBRK,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.SUSP as SUSP,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.SAL_SUB as SAL_SUB,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.SUIT_CD as SUIT_CD,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.SLC_CD as SLC_CD,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.REPT_DT as REPT_DT,
DATECONV_CYYMMDD ( amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.REPT_DT ) as out_REPT_DT,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.ACCTG_DT as ACCTG_DT,
DATECONV_CYYMMDD ( amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.ACCTG_DT ) as out_ACCTG_DT,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.CAUSE_CD as CAUSE_CD,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.CAUSE_DESC as CAUSE_DESC,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.COT_PLN as COT_PLN,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.CAT_CD as CAT_CD,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.RISK_ID as RISK_ID,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.CLOSE_CD as CLOSE_CD,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.CLOSE_DT as CLOSE_DT,
DATECONV_CYYMMDD ( amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.CLOSE_DT ) as out_CLOSE_DT,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.NO_REO as NO_REO,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.REIN as REIN,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.ENC_CD as ENC_CD,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.AGTNO as AGTNO,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.SCNO as SCNO,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.INSD_NM as INSD_NM,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.OCC_CD as OCC_CD,
CASE WHEN ( SUBSTR ( amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.TIME_O_LOSS , 3 , 1 ) = ''A'' OR SUBSTR ( amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.TIME_O_LOSS , 3 , 1 ) = ''P'' ) THEN ( amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.TIME_O_LOSS || ''M'' ) ELSE amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.TIME_O_LOSS END as var_TIME_O_LOSS,
CASE WHEN IS_DATE ( var_TIME_O_LOSS , ''HH12AM'' ) THEN var_TIME_O_LOSS ELSE ''INVALID'' END as out_TIME_O_LOSS,
CASE WHEN ( TO_NUMBER(amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.SUBROGATION_DATE) = 0 OR amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.SUBROGATION_DATE IS NULL ) THEN NULL ELSE LPAD ( TO_CHAR ( TO_NUMBER(amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.SUBROGATION_DATE) ) , 4 , ''0'' ) END as out_SUBROGATION_DATE,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.PURG_CLM_FROM_FOLDER as PURG_CLM_FROM_FOLDER,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.RECOVERABLE_LOSS_CD as RECOVERABLE_LOSS_CD,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.RECOVERABLE_LOSS_AMT as RECOVERABLE_LOSS_AMT,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.PREM_FINANCE as PREM_FINANCE,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.HIGH_PERFORM_CODE as HIGH_PERFORM_CODE,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.FIBER_GLASS_CODE as FIBER_GLASS_CODE,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.INEXPER_DRVR_CODE as INEXPER_DRVR_CODE,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.FINANCIAL_RESPONBILITY_CODE as FINANCIAL_RESPONBILITY_CODE,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.MISC_DISCOUNT as MISC_DISCOUNT,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.HO_DISCOUNT as HO_DISCOUNT,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.SM_SP_POLICY_IND as SM_SP_POLICY_IND,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.PREV_AGENT as PREV_AGENT,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.CHANGE_AGT_DT as CHANGE_AGT_DT,
DATECONV_CYYMMDD ( amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.CHANGE_AGT_DT ) as out_CHANGE_AGT_DT,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.WC_EFF_YR as WC_EFF_YR,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.POL_FOLDER_DATE as POL_FOLDER_DATE,
DATECONV_CYYMMDD ( amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.POL_FOLDER_DATE ) as out_POL_FOLDER_DATE,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.TRANSFERRED_POL_NBR as TRANSFERRED_POL_NBR,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.CLUE_CHANGE_MMYY as CLUE_CHANGE_MMYY,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.CLUE_REPT_ITEM as CLUE_REPT_ITEM,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.MISS_FIRE_CLM_IND as MISS_FIRE_CLM_IND,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.TIMES_NOT_FOUND as TIMES_NOT_FOUND,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.TOT_RES_AMT as TOT_RES_AMT,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.TOT_PAID_AMT as TOT_PAID_AMT,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.HO_DEDUCTIBLE as HO_DEDUCTIBLE,
DATECONV_CYYMMDD ( amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.DATE_O_LOSS ) as v_DATE_OF_LOSS,
LPAD ( RTRIM ( TO_CHAR ( amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.POL_STATE ) ) , 2 , ''0'' ) as o_STATE,
RTRIM ( amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.CAT_CD ) as o_CAT_CD,
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL.source_record_id
FROM
amgdsq_clmfdm_CLMF_CLM_HO_NO_TRL
);
...
-- Component STG_CLMF_CLM_NO_TRL_HO, Type TARGET 
INSERT INTO DB_T_STAG_PROD.STG_CLMF_CLM_NO_TRL_HO
(
OPERATOR_ID,
COMPANY,
MRI,
