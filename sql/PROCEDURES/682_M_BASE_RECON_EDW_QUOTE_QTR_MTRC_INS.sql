...
CREATE OR REPLACE PROCEDURE ALFA_EDW_DEV.PUBLIC.M_BASE_RECON_EDW_QUOTE_QTR_MTRC_INS("WORKLET_NAME" VARCHAR)
RETURNS VARCHAR
LANGUAGE SQL
EXECUTE AS CALLER
AS ' 
...
FROM	
 ...
 WHERE RECON_EXTC_MTRC_INT.RECON_MTRC_LAYER =''EDW | QUOTES''
...
-- Component RECON_MTRC_EDW_QUOTES, Type TARGET 
