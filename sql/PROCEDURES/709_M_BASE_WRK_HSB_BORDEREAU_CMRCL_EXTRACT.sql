...
CREATE OR REPLACE PROCEDURE ALFA_EDW_DEV.PUBLIC.M_BASE_WRK_HSB_BORDEREAU_CMRCL_EXTRACT("WORKLET_NAME" VARCHAR)
RETURNS VARCHAR
LANGUAGE SQL
EXECUTE AS CALLER
AS ' 
...
UPPER ( RPAD ( SQ_src_HSB_BORDEREAU.MAIL_CITY , 20 , '' '' ) ) as out_MAIL_CITY,
