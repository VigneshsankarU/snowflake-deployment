...
CREATE OR REPLACE PROCEDURE ALFA_EDW_DEV.PUBLIC.M_CLMF_CLAIM_CORE_HO("RUN_ID" VARCHAR)
RETURNS VARCHAR
LANGUAGE SQL
EXECUTE AS CALLER
AS ' 
...
-- Component sq_STG_CLMF_CLM_NO_TRL_HO, Type SOURCE 
CREATE OR REPLACE TEMPORARY TABLE sq_STG_CLMF_CLM_NO_TRL_HO AS
(
...
$64 as TOT_PAID_AMT,
$65 as DEDUCTIBLE,
$66 as source_record_id
FROM (
SELECT SRC.*, row_number() over (order by 1) AS source_record_id FROM (
SELECT DISTINCT TRIM(STG_CLMF_CLM_NO_TRL_HO.OPERATOR_ID) AS OPERATOR_ID,
STG_CLMF_CLM_NO_TRL_HO.COMPANY, 
TRIM(STG_CLMF_CLM_NO_TRL_HO.MRI) AS MRI,
STG_CLMF_CLM_NO_TRL_HO.TRL_COUNT, 
STG_CLMF_CLM_NO_TRL_HO.POL_STATE, 
STG_CLMF_CLM_NO_TRL_HO.PFX, 
STG_CLMF_CLM_NO_TRL_HO.PNO, 
STG_CLMF_CLM_NO_TRL_HO.DATE_O_LOSS, 
STG_CLMF_CLM_NO_TRL_HO.DATE_O_LOSS_DT, 
STG_CLMF_CLM_NO_TRL_HO.SEQNO, 
STG_CLMF_CLM_NO_TRL_HO.TRANS_ID, 
TRIM(STG_CLMF_CLM_NO_TRL_HO.DIST) AS DIST,
TRIM(STG_CLMF_CLM_NO_TRL_HO.ADJSYM) AS ADJSYM,
TRIM(STG_CLMF_CLM_NO_TRL_HO.FAST_TRAC) AS FAST_TRAC,
TRIM(STG_CLMF_CLM_NO_TRL_HO.GLASBRK) AS GLASBRK,
TRIM(STG_CLMF_CLM_NO_TRL_HO.SUSP) AS SUSP,
TRIM(STG_CLMF_CLM_NO_TRL_HO.SAL_SUB) AS SAL_SUB,
TRIM(STG_CLMF_CLM_NO_TRL_HO.SUIT_CD) AS SUIT_CD,
TRIM(STG_CLMF_CLM_NO_TRL_HO.SLC_CD) AS SLC_CD,
STG_CLMF_CLM_NO_TRL_HO.REPT_DT, 
STG_CLMF_CLM_NO_TRL_HO.REPT_DATE, 
STG_CLMF_CLM_NO_TRL_HO.ACCTG_DT, 
STG_CLMF_CLM_NO_TRL_HO.ACCTG_DATE, 
STG_CLMF_CLM_NO_TRL_HO.CAUSE_CD, 
TRIM(STG_CLMF_CLM_NO_TRL_HO.CAUSE_DESC) AS CAUSE_DESC,
TRIM(STG_CLMF_CLM_NO_TRL_HO.COT_PLN) AS COT_PLN,
TRIM(STG_CLMF_CLM_NO_TRL_HO.CAT_CD) AS CAT_CD,
TRIM(STG_CLMF_CLM_NO_TRL_HO.RISK_ID) AS RISK_ID,
TRIM(STG_CLMF_CLM_NO_TRL_HO.CLOSE_CD) AS CLOSE_CD,
STG_CLMF_CLM_NO_TRL_HO.CLOSE_DT, 
STG_CLMF_CLM_NO_TRL_HO.CLOSE_DATE, 
STG_CLMF_CLM_NO_TRL_HO.NO_REO, 
TRIM(STG_CLMF_CLM_NO_TRL_HO.REIN) AS REIN,
TRIM(STG_CLMF_CLM_NO_TRL_HO.ENC_CD) AS ENC_CD,
STG_CLMF_CLM_NO_TRL_HO.AGTNO, 
STG_CLMF_CLM_NO_TRL_HO.SCNO, 
TRIM(STG_CLMF_CLM_NO_TRL_HO.INSD_NM)INSD_NM,
TRIM(STG_CLMF_CLM_NO_TRL_HO.OCC_CD) AS OCC_CD,
TRIM(STG_CLMF_CLM_NO_TRL_HO.TIME_O_LOSS) AS TIME_O_LOSS,
STG_CLMF_CLM_NO_TRL_HO.SUBROGATION_DATE, 
TRIM(STG_CLMF_CLM_NO_TRL_HO.PURG_CLM_FROM_FOLDER) AS PURG_CLM_FROM_FOLDER,
TRIM(STG_CLMF_CLM_NO_TRL_HO.RECOVERABLE_LOSS_CD) AS RECOVERABLE_LOSS_CD,
STG_CLMF_CLM_NO_TRL_HO.RECOVERABLE_LOSS_AMT, 
TRIM(STG_CLMF_CLM_NO_TRL_HO.PREM_FINANCE) AS PREM_FINANCE,
TRIM(STG_CLMF_CLM_NO_TRL_HO.HIGH_PERFORM_CODE) AS HIGH_PERFORM_CODE,
TRIM(STG_CLMF_CLM_NO_TRL_HO.FIBER_GLASS_CODE) AS FIBER_GLASS_CODE,
TRIM(STG_CLMF_CLM_NO_TRL_HO.INEXPER_DRVR_CODE) AS INEXPER_DRVR_CODE,
TRIM(STG_CLMF_CLM_NO_TRL_HO.FINANCIAL_RESPONBILITY_CODE) AS FINANCIAL_RESPONBILITY_CODE,
TRIM(STG_CLMF_CLM_NO_TRL_HO.MISC_DISCOUNT) AS MISC_DISCOUNT,
TRIM(STG_CLMF_CLM_NO_TRL_HO.HO_DISCOUNT) AS HO_DISCOUNT,
TRIM(STG_CLMF_CLM_NO_TRL_HO.SM_SP_POLICY_IND) AS SM_SP_POLICY_IND,
STG_CLMF_CLM_NO_TRL_HO.PREV_AGENT, 
STG_CLMF_CLM_NO_TRL_HO.CHANGE_AGT_DT, 
STG_CLMF_CLM_NO_TRL_HO.CHANGE_AGT_DATE, 
STG_CLMF_CLM_NO_TRL_HO.WC_EFF_YR, 
STG_CLMF_CLM_NO_TRL_HO.POL_FOLDER_DATE, 
STG_CLMF_CLM_NO_TRL_HO.POL_FOLDER_DT, 
TRIM(STG_CLMF_CLM_NO_TRL_HO.TRANSFERRED_POL_NBR) AS TRANSFERRED_POL_NBR,
TRIM(STG_CLMF_CLM_NO_TRL_HO.CLUE_CHANGE_MMYY) AS CLUE_CHANGE_MMYY,
TRIM(STG_CLMF_CLM_NO_TRL_HO.CLUE_REPT_ITEM) AS CLUE_REPT_ITEM,
TRIM(STG_CLMF_CLM_NO_TRL_HO.MISS_FIRE_CLM_IND) AS MISS_FIRE_CLM_IND,
STG_CLMF_CLM_NO_TRL_HO.TIMES_NOT_FOUND, 
STG_CLMF_CLM_NO_TRL_HO.TOT_RES_AMT, 
STG_CLMF_CLM_NO_TRL_HO.TOT_PAID_AMT, 
STG_CLMF_CLM_NO_TRL_HO.DEDUCTIBLE
FROM
 DB_T_STAG_PROD.STG_CLMF_CLM_NO_TRL_HO 
 
 UNION 
 SELECT DISTINCT TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.OPERATOR_ID) AS OPERATOR_ID,
STG_CLMF_CLM_LOSS_RESERVE_HO.COMPANY, 
TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.MRI) AS MRI,
STG_CLMF_CLM_LOSS_RESERVE_HO.TRL_COUNT, 
STG_CLMF_CLM_LOSS_RESERVE_HO.POL_STATE, 
STG_CLMF_CLM_LOSS_RESERVE_HO.PFX, 
STG_CLMF_CLM_LOSS_RESERVE_HO.PNO, 
STG_CLMF_CLM_LOSS_RESERVE_HO.DATE_O_LOSS, 
STG_CLMF_CLM_LOSS_RESERVE_HO.DATE_O_LOSS_DATE, 
STG_CLMF_CLM_LOSS_RESERVE_HO.SEQNO, 
STG_CLMF_CLM_LOSS_RESERVE_HO.TRANS_ID, 
TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.DIST) AS DIST,
TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.ADJSYM) AS ADJSYM,
TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.FAST_TRAC) AS FAST_TRAC,
TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.GLASBRK) AS GLASBRK,
TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.SUSP) AS SUSP,
TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.SAL_SUB) AS SAL_SUB,
TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.SUIT_CD) AS SUIT_CD,
TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.SLC_CD) AS SLC_CD,
STG_CLMF_CLM_LOSS_RESERVE_HO.REPT_DT, 
STG_CLMF_CLM_LOSS_RESERVE_HO.REPT_DATE, 
STG_CLMF_CLM_LOSS_RESERVE_HO.ACCTG_DT, 
STG_CLMF_CLM_LOSS_RESERVE_HO.ACCTG_DATE, 
STG_CLMF_CLM_LOSS_RESERVE_HO.CAUSE_CD, 
TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.CAUSE_DESC) AS CAUSE_DESC,
TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.COT_PLN) AS COT_PLN,
TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.CAT_CD) AS CAT_CD,
TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.RISK_ID) AS RISK_ID,
TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.CLOSE_CD) AS CLOSE_CD,
STG_CLMF_CLM_LOSS_RESERVE_HO.CLOSE_DT, 
STG_CLMF_CLM_LOSS_RESERVE_HO.CLOSE_DATE, 
STG_CLMF_CLM_LOSS_RESERVE_HO.NO_REO, 
TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.REIN) AS REIN,
TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.ENC_CD) AS ENC_CD,
STG_CLMF_CLM_LOSS_RESERVE_HO.AGTNO, 
STG_CLMF_CLM_LOSS_RESERVE_HO.SCNO, 
TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.INSD_NM)INSD_NM,
TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.OCC_CD) AS OCC_CD,
TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.TIME_O_LOSS) AS TIME_O_LOSS,
STG_CLMF_CLM_LOSS_RESERVE_HO.SUBROGATION_DATE, 
TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.PURG_CLM_FROM_FOLDER) AS PURG_CLM_FROM_FOLDER,
TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.RECOVERABLE_LOSS_CD) AS RECOVERABLE_LOSS_CD,
STG_CLMF_CLM_LOSS_RESERVE_HO.RECOVERABLE_LOSS_AMT, 
TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.PREM_FINANCE) AS PREM_FINANCE,
TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.HIGH_PERFORM_CODE) AS HIGH_PERFORM_CODE,
TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.FIBER_GLASS_CODE) AS FIBER_GLASS_CODE,
TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.INEXPER_DRVR_CODE) AS INEXPER_DRVR_CODE,
TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.FINANCIAL_RESPONBILITY_CODE) AS FINANCIAL_RESPONBILITY_CODE,
TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.MISC_DISCOUNT) AS MISC_DISCOUNT,
TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.HO_DISCOUNT) AS HO_DISCOUNT,
TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.SM_SP_POLICY_IND) AS SM_SP_POLICY_IND,
STG_CLMF_CLM_LOSS_RESERVE_HO.PREV_AGENT, 
STG_CLMF_CLM_LOSS_RESERVE_HO.CHANGE_AGT_DT, 
STG_CLMF_CLM_LOSS_RESERVE_HO.CHANGE_AGT_DATE, 
STG_CLMF_CLM_LOSS_RESERVE_HO.WC_EFF_YR, 
STG_CLMF_CLM_LOSS_RESERVE_HO.POL_FOLDER_DATE, 
STG_CLMF_CLM_LOSS_RESERVE_HO.POL_FOLDER_DT, 
TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.TRANSFERRED_POL_NBR) AS TRANSFERRED_POL_NBR,
TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.CLUE_CHANGE_MMYY) AS CLUE_CHANGE_MMYY,
TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.CLUE_REPT_ITEM) AS CLUE_REPT_ITEM,
TRIM(STG_CLMF_CLM_LOSS_RESERVE_HO.MISS_FIRE_CLM_IND) AS MISS_FIRE_CLM_IND,
STG_CLMF_CLM_LOSS_RESERVE_HO.TIMES_NOT_FOUND, 
STG_CLMF_CLM_LOSS_RESERVE_HO.TOT_RES_AMT, 
STG_CLMF_CLM_LOSS_RESERVE_HO.TOT_PAID_AMT, 
STG_CLMF_CLM_LOSS_RESERVE_HO.DEDUCTIBLE  
FROM
 DB_T_STAG_PROD.STG_CLMF_CLM_LOSS_RESERVE_HO
 UNION 
  SELECT DISTINCT TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.OPERATOR_ID) AS OPERATOR_ID,
STG_CLMF_CLM_SURVEY_LTR_HO.COMPANY, 
TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.MRI) AS MRI,
STG_CLMF_CLM_SURVEY_LTR_HO.TRL_COUNT, 
STG_CLMF_CLM_SURVEY_LTR_HO.POL_STATE, 
STG_CLMF_CLM_SURVEY_LTR_HO.PFX, 
STG_CLMF_CLM_SURVEY_LTR_HO.PNO, 
STG_CLMF_CLM_SURVEY_LTR_HO.DATE_O_LOSS, 
STG_CLMF_CLM_SURVEY_LTR_HO.DATE_O_LOSS_DATE, 
STG_CLMF_CLM_SURVEY_LTR_HO.SEQNO, 
STG_CLMF_CLM_SURVEY_LTR_HO.TRANS_ID, 
TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.DIST)  AS DIST,
TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.ADJSYM) AS ADJSYM,
TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.FAST_TRAC) AS FAST_TRAC,
TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.GLASBRK) AS GLASBRK,
TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.SUSP) AS SUSP,
TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.SAL_SUB) AS SAL_SUB,
TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.SUIT_CD) AS SUIT_CD,
TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.SLC_CD) AS SLC_CD,
STG_CLMF_CLM_SURVEY_LTR_HO.REPT_DT, 
STG_CLMF_CLM_SURVEY_LTR_HO.REPT_DATE, 
STG_CLMF_CLM_SURVEY_LTR_HO.ACCTG_DT, 
STG_CLMF_CLM_SURVEY_LTR_HO.ACCTG_DATE, 
STG_CLMF_CLM_SURVEY_LTR_HO.CAUSE_CD, 
TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.CAUSE_DESC) AS CAUSE_DESC,
TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.COT_PLN) AS COT_PLN,
TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.CAT_CD) AS CAT_CD,
TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.RISK_ID) AS RISK_ID,
TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.CLOSE_CD) AS CLOSE_CD,
STG_CLMF_CLM_SURVEY_LTR_HO.CLOSE_DT, 
STG_CLMF_CLM_SURVEY_LTR_HO.CLOSE_DATE, 
STG_CLMF_CLM_SURVEY_LTR_HO.NO_REO, 
TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.REIN) AS REIN,
TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.ENC_CD) AS ENC_CD,
STG_CLMF_CLM_SURVEY_LTR_HO.AGTNO, 
STG_CLMF_CLM_SURVEY_LTR_HO.SCNO, 
TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.INSD_NM)INSD_NM,
TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.OCC_CD) AS OCC_CD,
TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.TIME_O_LOSS) AS TIME_O_LOSS,
STG_CLMF_CLM_SURVEY_LTR_HO.SUBROGATION_DATE, 
TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.PURG_CLM_FROM_FOLDER) AS PURG_CLM_FROM_FOLDER,
TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.RECOVERABLE_LOSS_CD) AS RECOVERABLE_LOSS_CD,
STG_CLMF_CLM_SURVEY_LTR_HO.RECOVERABLE_LOSS_AMT, 
TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.PREM_FINANCE) AS PREM_FINANCE,
TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.HIGH_PERFORM_CODE) AS HIGH_PERFORM_CODE,
TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.FIBER_GLASS_CODE) AS FIBER_GLASS_CODE,
TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.INEXPER_DRVR_CODE) AS INEXPER_DRVR_CODE,
TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.FINANCIAL_RESPONBILITY_CODE) AS FINANCIAL_RESPONBILITY_CODE,
TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.MISC_DISCOUNT) AS MISC_DISCOUNT,
TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.HO_DISCOUNT) AS HO_DISCOUNT,
TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.SM_SP_POLICY_IND) AS SM_SP_POLICY_IND,
STG_CLMF_CLM_SURVEY_LTR_HO.PREV_AGENT, 
STG_CLMF_CLM_SURVEY_LTR_HO.CHANGE_AGT_DT, 
STG_CLMF_CLM_SURVEY_LTR_HO.CHANGE_AGT_DATE, 
STG_CLMF_CLM_SURVEY_LTR_HO.WC_EFF_YR, 
STG_CLMF_CLM_SURVEY_LTR_HO.POL_FOLDER_DATE, 
STG_CLMF_CLM_SURVEY_LTR_HO.POL_FOLDER_DT, 
TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.TRANSFERRED_POL_NBR) AS TRANSFERRED_POL_NBR,
TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.CLUE_CHANGE_MMYY) AS CLUE_CHANGE_MMYY,
TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.CLUE_REPT_ITEM) AS CLUE_REPT_ITEM,
TRIM(STG_CLMF_CLM_SURVEY_LTR_HO.MISS_FIRE_CLM_IND) AS MISS_FIRE_CLM_IND,
STG_CLMF_CLM_SURVEY_LTR_HO.TIMES_NOT_FOUND, 
STG_CLMF_CLM_SURVEY_LTR_HO.TOT_RES_AMT, 
STG_CLMF_CLM_SURVEY_LTR_HO.TOT_PAID_AMT, 
STG_CLMF_CLM_SURVEY_LTR_HO.DEDUCTIBLE  
FROM
 DB_T_STAG_PROD.STG_CLMF_CLM_SURVEY_LTR_HO
) SRC
)
);
...
(
SELECT
sq_STG_CLMF_CLM_NO_TRL_HO.OPERATOR_ID as OPERATOR_ID,
sq_STG_CLMF_CLM_NO_TRL_HO.COMPANY as COMPANY,
sq_STG_CLMF_CLM_NO_TRL_HO.MRI as MRI,
sq_STG_CLMF_CLM_NO_TRL_HO.TRL_COUNT as TRL_COUNT,
sq_STG_CLMF_CLM_NO_TRL_HO.POL_STATE as POL_STATE,
sq_STG_CLMF_CLM_NO_TRL_HO.PFX as PFX,
sq_STG_CLMF_CLM_NO_TRL_HO.PNO as PNO,
sq_STG_CLMF_CLM_NO_TRL_HO.DATE_O_LOSS as DATE_O_LOSS,
sq_STG_CLMF_CLM_NO_TRL_HO.DATE_O_LOSS_DT as DATE_O_LOSS_DT,
sq_STG_CLMF_CLM_NO_TRL_HO.SEQNO as SEQNO,
sq_STG_CLMF_CLM_NO_TRL_HO.TRANS_ID as TRANS_ID,
sq_STG_CLMF_CLM_NO_TRL_HO.DIST as DIST,
sq_STG_CLMF_CLM_NO_TRL_HO.ADJSYM as ADJSYM,
sq_STG_CLMF_CLM_NO_TRL_HO.FAST_TRAC as FAST_TRAC,
sq_STG_CLMF_CLM_NO_TRL_HO.GLASBRK as GLASBRK,
sq_STG_CLMF_CLM_NO_TRL_HO.SUSP as SUSP,
DECODE ( sq_STG_CLMF_CLM_NO_TRL_HO.SAL_SUB , ''1'' , ''Y'' , ''3'' , ''Y'' , ''2'' , ''N'' , ''V'' , ''N/A'' , ''N'' ) as out_SAL,
DECODE ( sq_STG_CLMF_CLM_NO_TRL_HO.SAL_SUB , ''1'' , ''N'' , ''3'' , ''N'' , ''2'' , ''Y'' , ''V'' , ''N/A'' , ''N'' ) as out_SUB,
sq_STG_CLMF_CLM_NO_TRL_HO.SUIT_CD as SUIT_CD,
sq_STG_CLMF_CLM_NO_TRL_HO.SLC_CD as SLC_CD,
sq_STG_CLMF_CLM_NO_TRL_HO.REPT_DT as REPT_DT,
sq_STG_CLMF_CLM_NO_TRL_HO.REPT_DATE as REPT_DATE,
sq_STG_CLMF_CLM_NO_TRL_HO.ACCTG_DT as ACCTG_DT,
sq_STG_CLMF_CLM_NO_TRL_HO.ACCTG_DATE as ACCTG_DATE,
sq_STG_CLMF_CLM_NO_TRL_HO.CAUSE_CD as CAUSE_CD,
sq_STG_CLMF_CLM_NO_TRL_HO.CAUSE_DESC as CAUSE_DESC,
sq_STG_CLMF_CLM_NO_TRL_HO.COT_PLN as COT_PLN,
sq_STG_CLMF_CLM_NO_TRL_HO.CAT_CD as CAT_CD,
sq_STG_CLMF_CLM_NO_TRL_HO.RISK_ID as RISK_ID,
sq_STG_CLMF_CLM_NO_TRL_HO.CLOSE_CD as CLOSE_CD,
sq_STG_CLMF_CLM_NO_TRL_HO.CLOSE_DT as CLOSE_DT,
sq_STG_CLMF_CLM_NO_TRL_HO.CLOSE_DATE as CLOSE_DATE,
sq_STG_CLMF_CLM_NO_TRL_HO.NO_REO as NO_REO,
sq_STG_CLMF_CLM_NO_TRL_HO.REIN as REIN,
sq_STG_CLMF_CLM_NO_TRL_HO.ENC_CD as ENC_CD,
sq_STG_CLMF_CLM_NO_TRL_HO.AGTNO as AGTNO,
sq_STG_CLMF_CLM_NO_TRL_HO.SCNO as SCNO,
sq_STG_CLMF_CLM_NO_TRL_HO.INSD_NM as INSD_NM,
sq_STG_CLMF_CLM_NO_TRL_HO.OCC_CD as OCC_CD,
sq_STG_CLMF_CLM_NO_TRL_HO.TIME_O_LOSS as TIME_O_LOSS,
sq_STG_CLMF_CLM_NO_TRL_HO.SUBROGATION_DATE as SUBROGATION_DATE,
sq_STG_CLMF_CLM_NO_TRL_HO.PURG_CLM_FROM_FOLDER as PURG_CLM_FROM_FOLDER,
sq_STG_CLMF_CLM_NO_TRL_HO.RECOVERABLE_LOSS_CD as RECOVERABLE_LOSS_CD,
sq_STG_CLMF_CLM_NO_TRL_HO.RECOVERABLE_LOSS_AMT as RECOVERABLE_LOSS_AMT,
sq_STG_CLMF_CLM_NO_TRL_HO.PREM_FINANCE as PREM_FINANCE,
DECODE ( sq_STG_CLMF_CLM_NO_TRL_HO.PREM_FINANCE , ''M'' , ''Y'' , ''N'' ) as MONTHLY_BILLING,
sq_STG_CLMF_CLM_NO_TRL_HO.HIGH_PERFORM_CODE as HIGH_PERFORM_CODE,
sq_STG_CLMF_CLM_NO_TRL_HO.FIBER_GLASS_CODE as FIBER_GLASS_CODE,
sq_STG_CLMF_CLM_NO_TRL_HO.INEXPER_DRVR_CODE as INEXPER_DRVR_CODE,
sq_STG_CLMF_CLM_NO_TRL_HO.FINANCIAL_RESPONBILITY_CODE as FINANCIAL_RESPONBILITY_CODE,
sq_STG_CLMF_CLM_NO_TRL_HO.MISC_DISCOUNT as MISC_DISCOUNT,
sq_STG_CLMF_CLM_NO_TRL_HO.HO_DISCOUNT as HO_DISCOUNT,
sq_STG_CLMF_CLM_NO_TRL_HO.SM_SP_POLICY_IND as SM_SP_POLICY_IND,
sq_STG_CLMF_CLM_NO_TRL_HO.PREV_AGENT as PREV_AGENT,
sq_STG_CLMF_CLM_NO_TRL_HO.CHANGE_AGT_DT as CHANGE_AGT_DT,
sq_STG_CLMF_CLM_NO_TRL_HO.CHANGE_AGT_DATE as CHANGE_AGT_DATE,
sq_STG_CLMF_CLM_NO_TRL_HO.WC_EFF_YR as WC_EFF_YR,
sq_STG_CLMF_CLM_NO_TRL_HO.POL_FOLDER_DATE as POL_FOLDER_DATE,
sq_STG_CLMF_CLM_NO_TRL_HO.POL_FOLDER_DT as POL_FOLDER_DT,
sq_STG_CLMF_CLM_NO_TRL_HO.TRANSFERRED_POL_NBR as TRANSFERRED_POL_NBR,
sq_STG_CLMF_CLM_NO_TRL_HO.CLUE_CHANGE_MMYY as CLUE_CHANGE_MMYY,
sq_STG_CLMF_CLM_NO_TRL_HO.CLUE_REPT_ITEM as CLUE_REPT_ITEM,
sq_STG_CLMF_CLM_NO_TRL_HO.MISS_FIRE_CLM_IND as MISS_FIRE_CLM_IND,
sq_STG_CLMF_CLM_NO_TRL_HO.TIMES_NOT_FOUND as TIMES_NOT_FOUND,
sq_STG_CLMF_CLM_NO_TRL_HO.TOT_RES_AMT as TOT_RES_AMT,
sq_STG_CLMF_CLM_NO_TRL_HO.TOT_PAID_AMT as TOT_PAID_AMT,
...
sq_STG_CLMF_CLM_NO_TRL_HO.DEDUCTIBLE as DEDUCTIBLE,
sq_STG_CLMF_CLM_NO_TRL_HO.source_record_id,
row_number() over (partition by sq_STG_CLMF_CLM_NO_TRL_HO.source_record_id order by sq_STG_CLMF_CLM_NO_TRL_HO.source_record_id) as RNK
FROM
sq_STG_CLMF_CLM_NO_TRL_HO
...
exp_HOLD_DATA.DEDUCTIBLE as DEDUCTIBLE,
exp_HOLD_DATA.source_record_id
FROM
exp_HOLD_DATA
...
exp_CHECK.DEDUCTIBLE as DEDUCTIBLE,
...
-- Component CLMF_CLAIM_CORE_HO_UPD, Type TARGET 
/* Perform Updates */
MERGE INTO DB_T_CORE_PROD.CLMF_CLAIM_CORE
USING upd_CLMF_CLAIM_CORE
ON (DB_T_CORE_PROD.CLMF_CLAIM_CORE.CLAIM_SKEY = upd_CLMF_CLAIM_CORE.CLAIM_SKEY_lkp3 and DB_T_CORE_PROD.CLMF_CLAIM_CORE.CHG_EFF_DT = upd_CLMF_CLAIM_CORE.CHG_EFF_DT)
...
''NEW'' as out_CHECK1,
rtr_INS_UPD_INS.DEDUCTIBLE as DEDUCTIBLE1,
...
rtr_INS_UPD_UPD.DEDUCTIBLE as DEDUCTIBLE3,
rtr_INS_UPD_UPD.source_record_id
FROM
rtr_INS_UPD_UPD
);
...
-- Component CLMF_CLAIM_CORE_HO_INS_NK, Type TARGET 
...
exp_UPD_INS.DEDUCTIBLE3 as DEDUCTIBLE_CD,
...
-- Component CLMF_CLAIM_CORE_HO_INS, Type TARGET_EXPORT_PREPARE Stage data before exporting
CREATE OR REPLACE TEMPORARY TABLE CLMF_CLAIM_CORE_HO_INS AS
(
SELECT
...
exp_INS.DEDUCTIBLE1 as DEDUCTIBLE_CD,
...
copy into @public.edw_stage/CLMF_CLAIM_CORE_HO_INS from (select * from CLMF_CLAIM_CORE_HO_INS)
header=true
overwrite=true;
-- Component CLMF_CLAIM_CORE_HO_INS, Type EXPORT_DATA Exporting data
;
