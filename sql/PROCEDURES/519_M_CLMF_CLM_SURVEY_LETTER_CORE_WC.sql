...
CREATE OR REPLACE PROCEDURE ALFA_EDW_DEV.PUBLIC.M_CLMF_CLM_SURVEY_LETTER_CORE_WC("RUN_ID" VARCHAR)
RETURNS VARCHAR
LANGUAGE SQL
EXECUTE AS CALLER
AS ' 
...
-- Component sq_STG_CLMF_CLM_SURVEY_LTR_WC, Type SOURCE 
CREATE OR REPLACE TEMPORARY TABLE sq_STG_CLMF_CLM_SURVEY_LTR_WC AS
(
...
SELECT DISTINCT
TRIM(STG_CLMF_CLM_SURVEY_LTR_WC.OPERATOR_ID) AS OPERATOR_ID , 
...
STG_CLMF_CLM_SURVEY_LTR_WC.DATE_O_LOSS_DATE,
 ...
 STG_CLMF_CLM_SURVEY_LTR_WC.TRI_L,
 STG_CLMF_CLM_SURVEY_LTR_WC.SL_TYPE_SURVY_L, 
TRIM(STG_CLMF_CLM_SURVEY_LTR_WC.SL_NAME1_L) AS SL_NAME1_L,
TRIM(STG_CLMF_CLM_SURVEY_LTR_WC.SL_NAME2_L) AS SL_NAME2_L, 
TRIM(STG_CLMF_CLM_SURVEY_LTR_WC.SL_ADDRESS_L) AS SL_ADDRESS_L,
TRIM(STG_CLMF_CLM_SURVEY_LTR_WC.SL_CITY_L) AS SL_CITY_L,
TRIM(STG_CLMF_CLM_SURVEY_LTR_WC.SL_STATE_L) AS SL_STATE_L,
 STG_CLMF_CLM_SURVEY_LTR_WC.SL_ZIP_L,
 STG_CLMF_CLM_SURVEY_LTR_WC.SL_ZIP_EXT_L,
TRIM(STG_CLMF_CLM_SURVEY_LTR_WC.SL_DPX_L) AS SL_DPX_L,
 STG_CLMF_CLM_SURVEY_LTR_WC.SL_DNO_L, 
STG_CLMF_CLM_SURVEY_LTR_WC.SL_LETR_DT_L, 
STG_CLMF_CLM_SURVEY_LTR_WC.SL_LETR_DT_L_DATE,
 STG_CLMF_CLM_SURVEY_LTR_WC.SL_RET_CODE_L,
 STG_CLMF_CLM_SURVEY_LTR_WC.SL_2ND_3RD_DT_L,
 STG_CLMF_CLM_SURVEY_LTR_WC.SL_2ND_3RD_DT_L_DATE, 
TRIM(STG_CLMF_CLM_SURVEY_LTR_WC.SL_ADJ_NO_L) AS SL_ADJ_NO_L
FROM
...
(
SELECT
sq_STG_CLMF_CLM_SURVEY_LTR_WC.MRI as MRI,
sq_STG_CLMF_CLM_SURVEY_LTR_WC.POL_STATE as POL_STATE,
sq_STG_CLMF_CLM_SURVEY_LTR_WC.PFX as PFX,
sq_STG_CLMF_CLM_SURVEY_LTR_WC.PNO as PNO,
sq_STG_CLMF_CLM_SURVEY_LTR_WC.DATE_O_LOSS as DATE_O_LOSS,
sq_STG_CLMF_CLM_SURVEY_LTR_WC.DATE_O_LOSS_DATE as DATE_O_LOSS_DATE,
sq_STG_CLMF_CLM_SURVEY_LTR_WC.SEQNO as SEQNO,
sq_STG_CLMF_CLM_SURVEY_LTR_WC.SL_TYPE_SURVY_L as SL_TYPE_SURVY_L,
sq_STG_CLMF_CLM_SURVEY_LTR_WC.SL_NAME1_L as SL_NAME1_L,
sq_STG_CLMF_CLM_SURVEY_LTR_WC.SL_NAME2_L as SL_NAME2_L,
sq_STG_CLMF_CLM_SURVEY_LTR_WC.SL_ADDRESS_L as SL_ADDRESS_L,
sq_STG_CLMF_CLM_SURVEY_LTR_WC.SL_CITY_L as SL_CITY_L,
sq_STG_CLMF_CLM_SURVEY_LTR_WC.SL_STATE_L as SL_STATE_L,
sq_STG_CLMF_CLM_SURVEY_LTR_WC.SL_ZIP_L as SL_ZIP_L,
sq_STG_CLMF_CLM_SURVEY_LTR_WC.SL_ZIP_EXT_L as SL_ZIP_EXT_L,
sq_STG_CLMF_CLM_SURVEY_LTR_WC.SL_DPX_L as SL_DPX_L,
sq_STG_CLMF_CLM_SURVEY_LTR_WC.SL_DNO_L as SL_DNO_L,
sq_STG_CLMF_CLM_SURVEY_LTR_WC.SL_LETR_DT_L as SL_LETR_DT_L,
sq_STG_CLMF_CLM_SURVEY_LTR_WC.SL_LETR_DT_L_DATE as SL_LETR_DT_L_DATE,
sq_STG_CLMF_CLM_SURVEY_LTR_WC.SL_RET_CODE_L as SL_RET_CODE_L,
sq_STG_CLMF_CLM_SURVEY_LTR_WC.SL_2ND_3RD_DT_L as SL_2ND_3RD_DT_L,
sq_STG_CLMF_CLM_SURVEY_LTR_WC.SL_2ND_3RD_DT_L_DATE as SL_2ND_3RD_DT_L_DATE,
sq_STG_CLMF_CLM_SURVEY_LTR_WC.SL_ADJ_NO_L as SL_ADJ_NO_L,
sq_STG_CLMF_CLM_SURVEY_LTR_WC.source_record_id
FROM
sq_STG_CLMF_CLM_SURVEY_LTR_WC
);
