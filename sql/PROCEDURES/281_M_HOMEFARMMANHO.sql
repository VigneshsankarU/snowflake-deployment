...
CREATE OR REPLACE PROCEDURE ALFA_EDW_DEV.PUBLIC.M_HOMEFARMMANHO("RUN_ID" VARCHAR)
RETURNS VARCHAR
LANGUAGE SQL
EXECUTE AS CALLER
AS ' BEGIN 

-- Component HOMEFARMMANHO, Type TRUNCATE_TABLE 
TRUNCATE TABLE DB_T_STAG_MEMBXREF_PROD.HOMEFARMMANHO;
...
-- Component exp_homefarmmanho, Type EXPRESSION 
CREATE OR REPLACE TEMPORARY TABLE exp_homefarmmanho AS
(
SELECT
...
-- Component HOMEFARMMANHO, Type TARGET 
INSERT INTO DB_T_STAG_MEMBXREF_PROD.HOMEFARMMANHO
(
POLICY,
MEMBER_NUMBER,
AGENT,
...
SELECT
exp_homefarmmanho.POLICY as POLICY,
exp_homefarmmanho.MEMBER_NUMBER as MEMBER_NUMBER,
exp_homefarmmanho.AGENT as AGENT,
exp_homefarmmanho.FORM as FORM,
exp_homefarmmanho.MAKE_MODEL as MAKE_MODEL,
exp_homefarmmanho.LOCATION as LOCATION,
exp_homefarmmanho.NAME1 as NAME1,
exp_homefarmmanho.NAME2 as NAME2,
exp_homefarmmanho.DWELLING as DWELLING,
exp_homefarmmanho.OTHR_STR as OTHR_STR,
exp_homefarmmanho.PERSONAL_PROPERTY as PERSONAL_PROPERTY,
exp_homefarmmanho.LOSS_OF_USE as LOSS_OF_USE,
exp_homefarmmanho.LIABILITY as LIABILITY,
exp_homefarmmanho.MEDICAL as MEDICAL,
exp_homefarmmanho.DEDUCTIBLE as DEDUCTIBLE,
exp_homefarmmanho.CONSTRUCTION_YEAR as CONSTRUCTION_YEAR,
exp_homefarmmanho.EFF_DATE as EFF_DATE,
exp_homefarmmanho.EXP_DATE as EXP_DATE,
exp_homefarmmanho.PREMIUM as PREMIUM,
exp_homefarmmanho.STATUS as STATUS,
exp_homefarmmanho.MORTGAGE_IND as MORTGAGE_IND,
exp_homefarmmanho.DISCOUNT as DISCOUNT,
exp_homefarmmanho.HOME_ALERT_DISCOUNT as HOME_ALERT_DISCOUNT,
exp_homefarmmanho.VALUE_CLIENT_DISCOUNT as VALUE_CLIENT_DISCOUNT,
exp_homefarmmanho.SPRINKLER_DISCOUNT as SPRINKLER_DISCOUNT,
exp_homefarmmanho.NEW_HOME_DISCOUNT as NEW_HOME_DISCOUNT,
exp_homefarmmanho.BLD_RISK_DISCOUNT as BLD_RISK_DISCOUNT,
exp_homefarmmanho.END1 as END1,
exp_homefarmmanho.END2 as END2,
exp_homefarmmanho.END3 as END3,
exp_homefarmmanho.END4 as END4,
exp_homefarmmanho.END5 as END5,
exp_homefarmmanho.END6 as END6,
exp_homefarmmanho.END7 as END7,
exp_homefarmmanho.END8 as END8,
exp_homefarmmanho.END9 as END9,
exp_homefarmmanho.END10 as END10,
exp_homefarmmanho.OTHR_END1 as OTHR_END1,
exp_homefarmmanho.OTHR_END2 as OTHR_END2,
exp_homefarmmanho.OTHR_END3 as OTHR_END3,
exp_homefarmmanho.OTHR_END4 as OTHR_END4,
exp_homefarmmanho.OTHR_END5 as OTHR_END5,
exp_homefarmmanho.OTHR_END6 as OTHR_END6,
exp_homefarmmanho.OTHR_END7 as OTHR_END7,
exp_homefarmmanho.OTHR_END8 as OTHR_END8,
exp_homefarmmanho.OTHR_END9 as OTHR_END9,
exp_homefarmmanho.OTHR_END10 as OTHR_END10,
exp_homefarmmanho.CLAIM_DATE_1 as CLAIM_DATE_1,
exp_homefarmmanho.CLAIM_AMOUNT_1 as CLAIM_AMOUNT_1,
exp_homefarmmanho.CLAIM_DATE_2 as CLAIM_DATE_2,
exp_homefarmmanho.CLAIM_AMOUNT_2 as CLAIM_AMOUNT_2,
exp_homefarmmanho.CLAIM_DATE_3 as CLAIM_DATE_3,
exp_homefarmmanho.CLAIM_AMOUNT_3 as CLAIM_AMOUNT_3,
exp_homefarmmanho.CLAIM_DATE_4 as CLAIM_DATE_4,
exp_homefarmmanho.CLAIM_AMOUNT_4 as CLAIM_AMOUNT_4,
exp_homefarmmanho.CLAIM_DATE_5 as CLAIM_DATE_5,
exp_homefarmmanho.CLAIM_AMOUNT_5 as CLAIM_AMOUNT_5
FROM
exp_homefarmmanho;
