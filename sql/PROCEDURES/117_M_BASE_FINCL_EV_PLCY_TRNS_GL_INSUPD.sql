...
CREATE OR REPLACE PROCEDURE ALFA_EDW_DEV.PUBLIC.M_BASE_FINCL_EV_PLCY_TRNS_GL_INSUPD("RUN_ID" VARCHAR)
RETURNS VARCHAR
LANGUAGE SQL
EXECUTE AS CALLER
AS '
BEGIN
  ...
  (
         ...
         FROM   (
                         ...
                         FROM     (
                                                  SELECT DISTINCT xlat_src.ev_id,
                                                                  doc_id,
                                                                  financl_ev_type_cd,
                                                                  eff_date,
                                                                  refnumber,
                                                                  ...
                                                                  cast( (xlat_src.financl_ev_type_cd
                                                                                  ...
                                                                                  || cast(xlat_src.fincl_ev_prd_strt_dt AS                                                     VARCHAR(30))
                                                                                  ||cast( to_char(xlat_src.fincl_ev_prd_end_dt , ''YYYY-MM-DD HH24:MI:SS.FF6'') AS VARCHAR(30))
                                                                                  || trim( coalesce(xlat_src.ev_med_type_cd,0))
                                                                                  || trim(coalesce(xlat_src.funds_tfr_type_cd,0)) ) AS VARCHAR(1100)) AS sourcedata,
                                                                  cast( (tgt_fincl_ev.fincl_ev_type_cd
                                                                                  ...
                                                                                  || cast(tgt_fincl_ev.fincl_ev_prd_strt_dttm AS     VARCHAR(30))
                                                                                  || cast(tgt_fincl_ev.fincl_ev_prd_end_dttm AS      VARCHAR(30))
                                                                                  || trim(coalesce(tgt_fincl_ev.ev_med_type_cd,0))
                                                                                  || trim(coalesce(tgt_fincl_ev.funds_tfr_type_cd,0)) ) AS VARCHAR(1100)) AS targetdata,
                                                                  CASE
                                                  ...
                                                  FROM            (
                                                                                  SELECT DISTINCT evt.ev_id,
                                                                                                  ...
                                                                                                  to_timestamp_ntz(''9999-12-31 23:59:59.999999'' , ''YYYY-MM-DD HH24:MI:SS.FF6'' ) AS fincl_ev_prd_end_dt,
                                                                                                  retired,
                                                                                                  ev_med_type_cd,
                                                                                                  funds_tfr_type_cd,
                                                                                                  rnk,
                                                                                  ...
                                                                                  FROM            (
                                                                                                           SELECT   ev_act_type_code,
                                                                                                                    ...
                                                                                                                    cast(NULL AS VARCHAR(60))  AS funccode,
                                                                                                                    ...
                                                                                                                    gl_mo                      AS glmonth,
                                                                                                                    gl_yr                      AS glyear,
                                                                                                                    actng_dt                   AS accountingdate,
                                                                                                                    fincl_ev_prd_strt_dt,
                                                                                                                    rtrd                                                                                                                                                                                                        AS retired,
                                                                                                                    NULL                                                                                                                                                                                                        ev_med_type_cd,
                                                                                                                    NULL                                                                                                                                                                                                        funds_tfr_type_cd,
                                                                                                                    rank() over(PARTITION BY ev_act_type_code,key1,SUBTYPE ORDER BY fincl_ev_prd_strt_dt,cast(accountingdate AS DATE)DESC ,financl_ev_type,eff_dt,refnumber,trans_host_num,funccode,inv_invoicenumber,invitem_id,chargecategorycode,tranfer_method_typ,ev_strt_dt,ev_end_dt,glmonth,glyear ) AS rnk ,
                                                                                                                    cast(''MTHPOL0010'' AS VARCHAR(10))                                                                                                                                                                                                        AS query_id
                                                                                                           FROM     db_t_prod_stag.fincl_ev_x
                                                                                                           GROUP BY 1,
                                                                                                                    2,
                                                                                                                    15,
                                                                                                                    16,
                                                  ...
                                                  left outer join
                                                                  (
                                                                           SELECT   fincl_ev_prd_strt_dttm ,
                                                                                    ...
                                                                                    funds_tfr_type_cd ,
                                                                                    ev_id
                                                                           FROM     db_t_prod_core.fincl_ev qualify row_number() over(PARTITION BY ev_id ORDER BY edw_end_dttm DESC) = 1 ) AS tgt_fincl_ev
                                                  ON              xlat_src.ev_id = tgt_fincl_ev.ev_id ) src ) );
