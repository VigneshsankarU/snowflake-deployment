...
CREATE OR REPLACE PROCEDURE ALFA_EDW_DEV.PUBLIC.M_STAG_AGT_COMMINFO_HIST("PARAM_JSON" VARCHAR)
RETURNS VARCHAR
LANGUAGE SQL
EXECUTE AS CALLER
AS ' 
...
-- Component AGT_COMMINFO_HIST_1, Type TARGET 
INSERT INTO DB_T_PROD_STAG.AGT_COMMINFO_HIST
(
AGENT,
ACCOUNTING_DT,
STATE,
...
EXPTRANS.PAY_RW_PRIOR_1ST_M as PAY_RW_PRIOR_1ST_M,
EXPTRANS.PAY_RN_PRIOR_1ST_M as PAY_RN_PRIOR_1ST_M,
EXPTRANS.FORCE_COMM_RATE_WH as FORCE_COMM_RATE_WH,
...
EXPTRANS.MONTHS_INTO_VALIDA as MONTHS_INTO_VALIDA,
