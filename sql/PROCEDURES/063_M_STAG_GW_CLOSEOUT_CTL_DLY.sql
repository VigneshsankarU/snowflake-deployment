...
CREATE OR REPLACE PROCEDURE ALFA_EDW_DEV.PUBLIC.M_STAG_GW_CLOSEOUT_CTL_DLY("PARAM_JSON" VARCHAR)
RETURNS VARCHAR
LANGUAGE SQL
EXECUTE AS CALLER
AS ' 
...
SELECT	ACCOUNTING_YR, ACCOUNTING_MO, CLOSEOUT_TYPE, CLOSEOUT_SEQ_NBR,

		BEGINNING_TS, ENDING_TS, EOM_DT
DB_T_PROD_STAG
FROM

DB_T_PROD_COMN.GW_CLOSEOUT_CTL
) SRC
)
);
...
-- Component GW_CLOSEOUT_CTL_DLY, Type TARGET 
