-- Object Type: TASKS
-- Level: L5, ExecOrder: 305

create or replace task ALFA_EDW_DEV.PUBLIC.WKLT_BASE_PRTY_LOCTR_INSUPD__S_M_JOB_FAILURE
  ...
  IF (
    ...
    CALL s_m_job_failure('wklt_base_prty_loctr_insupd');
  END IF;
END;