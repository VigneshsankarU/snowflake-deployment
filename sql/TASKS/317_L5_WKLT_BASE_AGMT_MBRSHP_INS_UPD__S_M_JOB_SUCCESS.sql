-- Object Type: TASKS
-- Level: L5, ExecOrder: 171

create or replace task ALFA_EDW_DEV.PUBLIC.WKLT_BASE_AGMT_MBRSHP_INS_UPD__S_M_JOB_SUCCESS
  ...
  IF (
    ...
    CALL s_m_job_success('wklt_base_agmt_mbrshp_ins_upd');
  END IF;
END;