-- Object Type: TASKS
-- Level: L5, ExecOrder: 270

create or replace task ALFA_EDW_DEV.PUBLIC.WKLT_BASE_PRTY_AGMT_INSUPD__S_M_JOB_SUCCESS
  ...
  IF (
    ...
    CALL s_m_job_success('wklt_base_prty_agmt_insupd');
  END IF;
END;