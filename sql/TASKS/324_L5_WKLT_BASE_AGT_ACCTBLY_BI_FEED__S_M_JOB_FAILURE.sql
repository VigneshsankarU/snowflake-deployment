-- Object Type: TASKS
-- Level: L5, ExecOrder: 195

create or replace task ALFA_EDW_DEV.PUBLIC.WKLT_BASE_AGT_ACCTBLY_BI_FEED__S_M_JOB_FAILURE
  ...
  IF (
    ...
    CALL s_m_job_failure('wklt_base_agt_acctbly_bi_feed');
  END IF;
END;