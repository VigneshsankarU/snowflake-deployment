-- Object Type: TASKS
-- Level: L5, ExecOrder: 377

create or replace task ALFA_EDW_DEV.PUBLIC.WKLT_BASE_QUOTN_FEAT_LOCTR_INSUPD__S_M_JOB_FAILURE
  ...
  IF (
    ...
    CALL s_m_job_failure('wklt_base_quotn_feat_loctr_insupd');
  END IF;
END;