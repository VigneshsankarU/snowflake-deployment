-- Object Type: TASKS
-- Level: L5, ExecOrder: 232

create or replace task ALFA_EDW_DEV.PUBLIC.WKLT_BASE_PRIORLOSS_CLMPMT_INSUPD__S_M_JOB_SUCCESS
  ...
  IF (
    ...
    CALL s_m_job_success('wklt_base_priorloss_clmpmt_insupd');
  END IF;
END;