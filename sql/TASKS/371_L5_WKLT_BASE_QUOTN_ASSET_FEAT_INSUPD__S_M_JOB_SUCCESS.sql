-- Object Type: TASKS
-- Level: L5, ExecOrder: 336

create or replace task ALFA_EDW_DEV.PUBLIC.WKLT_BASE_QUOTN_ASSET_FEAT_INSUPD__S_M_JOB_SUCCESS
  ...
  IF (
    ...
    CALL s_m_job_success('wklt_base_quotn_asset_feat_insupd');
  END IF;
END;