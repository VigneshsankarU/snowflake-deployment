...
CREATE OR REPLACE FUNCTION ALFA_EDW_DEV.PUBLIC.SP_GET_SCOPED_PARAM("RUN_ID" VARCHAR, "PARAM_NAME" VARCHAR, "WORKFLOW_NAME" VARCHAR, "WORKLET_NAME" VARCHAR, "SESSION_NAME" VARCHAR)
RETURNS VARCHAR
LANGUAGE SQL
AS '
    SELECT param_value
